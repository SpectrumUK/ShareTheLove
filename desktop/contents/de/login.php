...
<div id="dsContent">
    ...
    <div class="dsLOGLeft">
		...
		?>
			<p>Vielen Dank. Wir haben dein Passwort zur&uuml;ckgesetzt und senden dir per E-Mail ein neues Passwort zu.</p><p>Bitte nutze dieses zugesandte Passwort, um dich beim nächsten Mal anzumelden.</p>
		<?php
}else{
...
?>
	...
	if ($dsv_register_sent == 'true'){
				...
				?>
				<p>Danke, f&uuml;r deine Anmeldung. Dein Benutzerkonto wurde angelegt.</p>
				<p>Du kannst dich auf unserer Webseite jederzeit mit deiner ausgew&auml;hlten E-Mail Adresse und deinem entsprechenden Passwort anmelden.</p>
	...
	<p>Registriere dich f&uuml;r unseren E-Mail Newsletter und erhalte aktuelle Angebote, Neuigkeiten und Informationen rund um unsere Produkte.</p>
            ...
            */
			?>    
                                        ...
                                        <label for="i_agreedterms">Ja, ich habe die <a href="<?php echo dsf_link('conditions.html','','SSL');?>" target="_blank">Allgemeinen Nutzungsbedingungen</a> <br />
und die <a href="<?php echo dsf_link('privacy.html','','SSL');?>" target="_blank">Datenschutzerkl&auml;rung</a> gelesen und akzeptiere sie.
</label>
                                        </div>
                						<div class="clear"></div>
                                        <div class="dsREGTick"><?php echo dsf_form_checkbox('i_marketing','1','','class="forminput"'); ?>
                                        <label for="i_marketing"><?php echo TRANSLATION_CHECKOUT_RECEIVE_EMAILS;?></label>
                                        </div>
                				<div class="clear"></div>
