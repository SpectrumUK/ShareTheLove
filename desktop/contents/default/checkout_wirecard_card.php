    ...
    <div class="dscheckoutSection">
						...
						<?php
						 ...
						 ?>
							...
							<div id="dsPNCardNumber"><?php echo TRANSLATION_CHECKOUT_CARD_NO_SPACE; ?></div>
							</div>
			...
			*/
			?>				
                            ...
                            <div id="dsWCPNCardCV2"><?php echo TRANSLATION_CHECKOUT_CARDS_REVERSE; ?></div>
							</div>
                            
                            <?php /*<div class="dscheckoutInput">
