...
<div class="dscheckoutCardSection">
 ...
 <div class="dscheckoutCardSections">
	<div class="dscheckoutTitle"><?php echo TRANSLATION_CHECKOUT_CARD_TITLE;?></div>
    ...
    <div class="dscheckoutSection">
						...
						<?php
						 ...
						 ?>
							<div class="dscheckoutInput"><label for="cc_number"><?php echo TRANSLATION_CHECKOUT_CARD_NUMBER;?> <span class="dsinputRequirement">*</span></label>
							...
							<div class="dscheckoutInput"><label for="cc_ctype"><?php echo TRANSLATION_CHECKOUT_CARD_TYPE;?> <span class="dsinputRequirement">*</span></label>
							<?php echo dsf_form_dropdown('cc_ctype', $dsv_cardtypes,$cc_ctype,'','forminput');?>
							</div>
							
							<div class="dscheckoutInput"><label for="cc_owner"><?php echo TRANSLATION_CHECKOUT_CARD_HOLDER;?> <span class="dsinputRequirement">*</span></label>
			...
			*/
			?>				
							<div class="dscheckoutInput"><label for="CV2"><?php echo TRANSLATION_CHECKOUT_CARD_SECURITY_CODE;?> <span class="dsinputRequirement">*</span></label>
							<?php echo dsf_form_input('CV2',$CV2,'size="10"','forminput');?>
							</div>
                            <div class="dscheckoutInput"><div><span class="dscheckoutNotes">(<?php echo TRANSLATION_CHECKOUT_CARD_CODE_INFO;?>)</span></div>
                            <div><span class="dscheckoutNotes">(<?php echo TRANSLATION_CHECKOUT_CARD_CODE_INFO_TWO;?>)</span></div>
                            </div>
...
<div id="dsbuttonConfirm"><?php echo dsf_submit_image($dsv_confirm_order_button, TRANSLATION_CHECKOUT_CONFIRM_ORDER);?></div>
