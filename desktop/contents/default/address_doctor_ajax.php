...
<?php
    ...
    <div class="dscheckoutInput">
    	<div class="addDoctorUse"><a href="javascript:void(0)" onclick="dsfAduse('<?php echo $section;?>','<?php echo $addkey;?>');"><?php echo dsf_image_button('useaddress_btn.gif', TRANSLATION_ADDOCTOR_ALLOCATE);?></a></div>
    	<div class="addDoctorUse"><a href="javascript:void(0)" onclick="dsfAdman('<?php echo $section;?>','<?php echo $addkey;?>');"><?php echo dsf_image_button('inputaddress_btn.gif', TRANSLATION_ADDDOCTOR_MANUAL);?></a></div>
    </div>
