			...
			<div id="custom_carousel" class="carousel slide" data-ride="carousel" data-interval="false">
				...
				<div class="carousel-inner">
					<div class="item active">
						<div class="container-fluid">
							<div class="row">
								<img src="../../../images/custom/ihearthome/products/neat/colouriron_show1.png" class="img-responsive">
							</div>
						</div>
					</div> 
				<!-- End Item -->
				...
				<div class="controls">
					<ul class="nav">
						<li data-target="#custom_carousel" data-slide-to="0" ><a href="#"><img src="../../../images/custom/ihearthome/products/neat/colouriron_show1_thumb.png" style="border: 1px solid #fff;"></a></li>
						<li data-target="#custom_carousel" data-slide-to="1"><a href="#"><img src="../../../images/custom/ihearthome/products/neat/colouriron_show2_thumb.png" style="border: 1px solid #fff;"></a></li>
						<li data-target="#custom_carousel" data-slide-to="2"><a href="#"><img src="../../../images/custom/ihearthome/products/neat/colouriron_show3_thumb.png" style="border: 1px solid #fff;"></a></li>
					</ul>
				</div>
			</div>
		<!-- End Carousel -->
