...
<p><a href="<?php echo $SSL_bref;?>image_upload.html?mechanicID=1"><?php echo sr_heart_replace(TRANSLATION_USER_CUSTOM_TEN);?></a> &nbsp;|&nbsp;<a href="<?php echo $bref;?>user_images.html?mechanicID=1"><?php echo TRANSLATION_GALLERY_HEADER;?></a>&nbsp;&nbsp;<span class="topright_instagram"></span> <span class="topright_facebook"></span></p>
</div>
...
<?php if ($dsv_show_social_network == 'true'){
					...
					echo sr_heart_replace($user_image_details['mechanic']['text_block_five']) . 
					'<img class="img-responsive centeritems " src="public/images/icons/socialmedia_clearbg.png" alt=""/>
...
//echo '<h2>Full Array =</h2>' . dsf_print_array($user_image_details);
