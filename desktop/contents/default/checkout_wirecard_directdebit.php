...
<div class="dsACSection">
	<h2><?php echo ds_strtoupper(TRANSLATION_CHECKOUT_DIRECTDEBIT_TITLE);?></h2>
    <div id="dsRequiredTxt"><span class="dsRequired">*</span> <?php echo TRANSLATION_CHECKOUT_REQUIRED_INFO; ?></div>
	 <div class="dscheckoutSection">
			<div class="checkoutDirectLogo"><?php echo dsf_image('custom/ec-zeichen.png', 'Electronic Cash', '100', '118');?></div>
						<?php
						 ...
						 ?>
 							...
 							<div class="dscheckoutInput"><label for="dd_iban"><?php echo TRANSLATION_CHECKOUT_SEPA_IBAN;?> <span class="dsinputRequirement">*</span></label>
							<?php echo dsf_form_input('dd_iban',$dd_iban,'size="10"','forminput');?>
							</div>



							<div class="dscheckoutInput"><label for="dd_bic"><?php echo TRANSLATION_CHECKOUT_SEPA_BIC;?> <span class="dsinputRequirement">*</span></label>
							<?php echo dsf_form_input('dd_bic',$dd_bic,'size="10"','forminput');?>
                            </div>
							


							<div class="dscheckoutInputTick">
                         	<?php echo dsf_form_checkbox('dd_signature', '1', (isset($_POST['dd_signature']) ? true : ''), 'class="dsChkHTick"'); ?>
                            <div class="dsChkHTickTxt"><?php echo TRANSLATION_CHECKOUT_SEPA_SIGNATURE;?></div>
							</div>
