...
if ($dsv_dynamic_form_action == 'success'){
	...
	// not sent
?>
    		<h1><?php echo ds_strtoupper($dsv_dynamic_form_name); ?></h1>
<?php
	// show the form.
...
foreach($dsv_dynamic_form_fields as $item){
	...
	?>
	  <div id="dsREGButton"><?php echo dsf_submit_image('product_reg_dk_btn.gif', 'Registrer'); ?></div>
	<?php
