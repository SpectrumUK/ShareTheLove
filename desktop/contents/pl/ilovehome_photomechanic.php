...
<script>
		function openFbPopUp() {
			FB.ui(
			  {
				  method: 'share',
				  href: '<?php echo $SSL_bref;?>image_upload.html?mechanicID=1&action=success',
			  },
			  function (response) {}
			);
		}
                ...
                <section class="content-wrapper">
                    ...
                    <div id="photo-container" class="message">
                        ...
                        <div class="text">
                            ...
                            <?php echo $image_upload_details['text_block_six']?>
<?php if ($dsv_show_social_network == 'true'){
                        ...
                        <div id="photo-container">
						    ...
						    <div class="form-step form-crop-it">
							    <ul class="vertical-list image-tools">
									...
									<li class="divider"><div id="btn-zoom-in"><i class="icon icon-text icon--zoom-in"><?php echo TRANSLATION_USER_IMAGE_ZOOMR;?></i></div></li>
    ...
    if (form.length) {
        ...
        $("#txtDobYear").rules("add", {
            ...
            messages: {
                ...
                range: "<?php echo $dsv_dynamic_form_fields['txtDobYear']['required_error'];?>",
                required: "<?php echo $dsv_dynamic_form_fields['txtDobDay']['required_error'];?>",
				check_date_of_birth: "<?php echo $dsv_dynamic_form_fields[177]['required_error'];?>"
            }
        });
        $("#txtEmail").rules("add", {
            email: true,
                ...
                required: "<?php echo $dsv_dynamic_form_fields['cb3']['required_error'];?>"
                            ...
                            <div class="form-step form-entry-form">
                                 <div class="form-wrapper">
                                    <div class="formRow no-margin"><?php echo $dsv_dynamic_form_fields[174]['long_text'];?></div>
                                    ...
                                    <div class="formRow no-margin"><span class="group-label"><?php echo $dsv_dynamic_form_fields[162]['long_text'];?></span></div>
                                    ...
                                    <div class="formRow no-margin"><?php echo $dsv_dynamic_form_fields[167]['long_text'];?></div>
                                    <div class="formRow">
                                    ...
                                    <div class="formRow chkbox">
                                        ...
                                        <label class="cbLabel" for="<?php echo $dsv_dynamic_form_fields['cb2']['field_name'];?>"><?php echo $dsv_dynamic_form_fields[185]['long_text'];?></label>
                                    </div>
                                    <div class="formRow chkbox">
                                        ...
                                        <label class="cbLabel" for="<?php echo $dsv_dynamic_form_fields['cb3']['field_name'];?>"><?php echo $dsv_dynamic_form_fields[186]['long_text'];?></label>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="<?php echo $SSL_bref;?>desktop/scripts/ihearthome/mechanic/validation.js"></script>
