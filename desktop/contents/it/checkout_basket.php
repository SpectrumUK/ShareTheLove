<div id="dsBasketMask" class="dsBasketITS2"></div>
...
<?php
				...
				*/
				?>
						...
						<div class="dscheckoutInput"><label for="i_invoice_county"><?php echo TRANSLATION_CHECKOUT_COUNTY;?>: <span class="dsinputRequirement">*</span></label>
				...
				<?php
					...
					?>	
                    <div class="dscheckoutInput"><div class="addDoctorFind"><a href="javascript:void(0)" onclick="dsfAdoc('invoice','i<?php echo time();?>');"><?php echo dsf_image('custom/findaddress_btn_it.gif', TRANSLATION_FIND_ADDRESS, '130', '32');?></a></div>
...
<?php
 ...
 ?>					
    ...
    <div id="dsRequiredTxt"><span class="dsRequired">*</span> <?php echo TRANSLATION_CHECKOUT_REQUIRED_INFO; ?></div>
						<div id="dsDeliveryTxt"><?php echo TRANSLATION_CHECKOUT_DELIVERY_MAIL_NAME;?></div>
                        <?php /*<div id="dsCardTxt"><?php echo TRANSLATION_CHECKOUT_DELIVERY_SUB_TITLE;?></div>*/?>
...
<?php
				...
				*/
					?>
                        ...
                        <div class="dscheckoutInput"><label for="i_delivery_county"><?php echo TRANSLATION_CHECKOUT_COUNTY;?>: <span class="dsinputRequirement">*</span></label>
				...
				<?php
					 ...
					 // show ajax button to find the address
					?>	
                    <div class="dscheckoutInput"><div class="addDoctorFind"><a href="javascript:void(0)" onclick="dsfAdoc('delivery','d<?php echo time();?>');"><?php echo dsf_image('custom/findaddress_btn_it.gif', TRANSLATION_FIND_ADDRESS, '130', '32');?></a></div>
				...
				*/
                ...
                <div class="dsACSection">
                 <div class="dsChkHldTick">
                        	...
                        	<label for="i_agreedterms"><a href="<?php echo 'termini-e-condizioni-di-vendita.html'; ?>" target = "_blank" ><?php echo TRANSLATION_CHECKOUT_TERMS_ONE;?></a></label>
                    	...
                    	<div class="dsChkHldTick">
                        	...
                        	<label for="i_agreedprivacy"><a href="<?php echo $dsv_privacy_url; ?>" target = "_blank" ><?php echo TRANSLATION_CHECKOUT_PRIVACY_ONE;?></a></label>
                    	</div>
                        
                     	<?php /*<div class="dsChkHldTick"><a href="<?php echo 'agb-onlineshop.html'; ?>" target = "_blank" ><?php echo TRANSLATION_CUSTOM_TEXT_SIX;?></a><br /><a href="<?php echo $dsv_privacy_url; ?>" target = "_blank" ><?php echo TRANSLATION_PAGE_PRIVACY;?></a></div>*/?>
