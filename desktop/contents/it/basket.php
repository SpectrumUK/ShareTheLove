<div id="dsBasketMask" class="dsBasketITS1"></div>
		...
		<?php
            ...
            <div id="dsbasketStart">
					...
					<table width="100%" cellspacing="0" border="0">
                               ...
                               <tr>
                               <td valign="middle" align="left" colspan="2" class="dsbasketHeaderItem"><?php echo ds_strtoupper(TRANSLATION_BASKET_PRODUCT); ?></td>
							   <td valign="middle" align="left" class="dsbasketHeaderItem"><?php echo ds_strtoupper(TRANSLATION_BASKET_QUANTITY); ?></td>
							   <td valign="middle" align="left" class="dsbasketHeaderItem"><?php echo ds_strtoupper(TRANSLATION_BASKET_PRICE); ?></td>
                               <td valign="middle" align="left" class="dsbasketHeaderItem"><?php echo ds_strtoupper(TRANSLATION_BASKET_REMOVE); ?></td>
                               </tr>
					    ...
					    <td width="420" align="left" valign="top" class="dsTBdata"><?php 
                          ...
                          <td width="112" align="center" valign="top" class="dsTBdata"><div class="dsBASproX"><?php echo dsf_submit_image('remove_btn.gif',TRANSLATION_BASKET_REMOVE,'name=remove' . $item['id']);?></div></td>
							</tr>
...
?>
                ...
                <div><?php echo dsf_form_input('input_voucher_code', $dsv_voucher_number,'size="20" class="forminput"') . dsf_submit_image($dsv_voucher_button, TRANSLATION_BASKET_VALIDATE, 'name="dsv_voucher_validator" align="left" vspace="3"');?></div>
				</div>
                </div>
