	...
	jQuery(document).ready(function(){
		jQuery("#DIV_TO_PLACE_COUNTDOWN").jCountdown({
			...
			displayLabel:true,
				    ...
				    <div class="dsScrollI"><a href="http://uk.russellhobbs.com/russell-hobbs-products/food-preparation/food-processors/food-processor-19001.html"><img src="http://uk.russellhobbs.com/images/page/hp4_empty_banner.gif" alt="" width="980" height="393" /></a></div>
					</div>
				</div>
<?php /*echo dsf_background_scroll($banner_array);*/ ?></div>
<div id="dsContent">
<?php
	/*
