...
*/?>
<div id="dsContentMask" class="dsDDCBanUK">&nbsp;</div>
<div id="dsMaskHolder"></div>
<div id="contentHeader">
<div id="dsScrollHolder">
<div id="dsScrollSlider">
		
            <div id="DIV_TO_PLACE_COUNTDOWN"></div>
               <script>
	jQuery(document).ready(function(){
		jQuery("#DIV_TO_PLACE_COUNTDOWN").jCountdown({
			timeText:"2013/12/05 23:59:59",
			timeZone:0,
			style:"slide",
			color:"black",
			width:310,
            ...
            <div class="dsScrollI"><a href="http://uk.russellhobbs.com/russell-hobbs-products/food-preparation/stand-mixers/silver-kitchen-machine-18553.html"><img src="http://uk.russellhobbs.com/images/page/hp3_empty_banner.gif" alt="" width="980" height="393" /></a></div>
            
<?php /*echo dsf_background_scroll($banner_array);*/ ?></div></div>
<div id="dsContent">
<?php
	/*
	...
	<div id="dsSMLban">
    	<ul>
            ...
            <li>
                ...
                <a href="<?php echo dsf_link('special-offers');?>">Up to 50% Off*<span class="dsSMLItem"><br />*selected products whilst stock last</span></a>
                </div>
            </li>
        </ul>
    </div>
