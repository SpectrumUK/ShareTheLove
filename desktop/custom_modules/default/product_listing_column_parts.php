													    ...
													    for ($i=0, $n=$total_products; $i<$n; $i++) {
															...
															$data_to_return .= '<li>';
																...
																if (isset($dsv_products[$i]['awards']) && is_array($dsv_products[$i]['awards'])){
																	...
																	$data_to_return .= '<div class="dsPROTitle">' . '<a href="' . $dsv_products[$i]['url'] . '" title="' . TRANSLATION_FIND_OUT_MORE . ' ' .$dsv_products[$i]['model'] . ' ' . $dsv_products[$i]['name'] .'">' . $dsv_products[$i]['name'] . '</a>' . '</div></div>' . "\n";
																	//$data_to_return .= '<div class="dsPROModel">' . '<a href="' . $dsv_products[$i]['url'] . '" title="' . TRANSLATION_FIND_OUT_MORE . ' ' .$dsv_products[$i]['model'] . ' ' . $dsv_products[$i]['name'] .'">' . $dsv_products[$i]['model'] . '</a>' . '</div>' . "\n";
